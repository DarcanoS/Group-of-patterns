\begin{NuevaPagina}{64}{94}{show1}
	...
	\CabeceraDeSubSeccionConAnchoN{9}{0}{14}{80}{PATRONES}{CTDiario}{CCDiario}
	\begin{NuevoParrafo}{11}{0}[24][22]
		\begin{Marco}[\LineaSupC][\LineaInfC][\LineaIzqC][\LineaDerC][CBlanco]
			\subseccionC{Diag. Clases Estrategy}
			\begin{center}
				\includegraphics[width=\textwidth,height=0.8\AltoP,keepaspectratio]{\RCR/patrones/estrategy_back_clases.png}
			\end{center}
		\end{Marco}
	\end{NuevoParrafo}
	\begin{NuevoParrafo}{11}{25}[28][22]
		\begin{Marco}[\LineaSupC][\LineaInfC][\LineaIzqC][\LineaDerC][CBlanco]
			\subseccionC{Diag. Secuencia Estrategy}
			\begin{center}
				\includegraphics[width=\textwidth,height=0.8\AltoP,keepaspectratio]{\RCR/patrones/estrategy_back_secuencia.png}
			\end{center}
		\end{Marco}
	\end{NuevoParrafo}
	\begin{NuevoParrafo}{11}{54}[28][22]
		\begin{Marco}[\LineaSupC][\LineaInfC][\LineaIzqC][\LineaDerC][CBlanco]
			\subseccionC{Diag. Clases Adapter}
			\begin{center}
				\includegraphics[width=\textwidth,height=0.8\AltoP,keepaspectratio]{\RCR/patrones/adapater_clases.jpeg}
			\end{center}
		\end{Marco}
	\end{NuevoParrafo}
	\begin{NuevoParrafo}{34}{0}[24][22]
		\begin{Marco}[\LineaSupC][\LineaInfC][\LineaIzqC][\LineaDerC][CBlanco]
			\subseccionC{Diag. Secuencia Adapter}
			\begin{center}
				\includegraphics[width=\textwidth,height=0.8\AltoP,keepaspectratio]{\RCR/patrones/adapater_secuencia.jpeg}
			\end{center}
		\end{Marco}
	\end{NuevoParrafo}
	% %----------------PATRONES------------------------------------------	
