\begin{NuevaPagina}{64}{94}{show}
	...
	\begin{NuevoParrafo}{11}{0}[34][16]
		\begin{Marco}[\LineaSupC][\LineaInfC][\LineaIzqC][\LineaDerC][CBlanco]
			\vspace{2pt}
			\begin{center}
				\includegraphics[width=\textwidth,height=1\AltoP,keepaspectratio]{\RCR/patrones/factory_back_clases.png}
			\end{center}
		\end{Marco}
	\end{NuevoParrafo}
	\begin{NuevoParrafo}{11}{35}[28][16]
		\begin{Marco}[\LineaSupC][\LineaInfC][\LineaIzqC][\LineaDerC][CBlanco]
			\vspace{2pt}
			\begin{center}
				\includegraphics[width=\textwidth,height=1\AltoP,keepaspectratio]{\RCR/patrones/factory_back_secuencia.png}
			\end{center}
		\end{Marco}
	\end{NuevoParrafo}
	% %----------------PATRONES------------------------------------------	
